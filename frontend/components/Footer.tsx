    ...
    <footer className="bg-[#050505] text-[#A39A90] pt-12 pb-8 px-4 sm:px-6 lg:px-12 font-sans overflow-hidden">
      <div className="max-w-[1400px] mx-auto space-y-8">
        ...
        <div className="bg-[#080808] border border-[#C9A24A]/30 rounded-3xl p-6 sm:p-10 lg:p-12 shadow-[0_20px_60px_rgba(0,0,0,0.95)] relative overflow-hidden">
          ...
          {/* Large Artistic Rose Graphic on the Right */}
          <div className="absolute bottom-0 right-0 pointer-events-none opacity-40 lg:opacity-60 translate-x-[20%] translate-y-[20%]">
             {/* Using a pseudo-element for the rose graphic, or an image if we had one. We'll use CSS shapes to simulate the glowing rose feel. */}
             <div className="w-[300px] h-[300px] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#E4002B]/40 via-[#D4AF37]/10 to-transparent blur-3xl rounded-full"></div>
             <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-[#D4AF37]/40 via-transparent to-transparent blur-2xl rounded-full mix-blend-overlay"></div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 relative z-10">
            ...
            ══════════════════════════════════════════ */}
            <div className="lg:col-span-3 space-y-6 lg:pr-4 border-b lg:border-b-0 lg:border-r border-[#221D22] pb-8 lg:pb-0">
              ...
              {/* 4 Feature Badges */}
              <div className="grid grid-cols-2 gap-2 pt-2 border-t border-[#1C161C]">
                <div className="flex flex-col items-center text-center p-2 rounded-xl bg-[#050505] border border-[#221D22]">
                  <Flower className="w-4 h-4 text-[#D4AF37] mb-1" />
              ...
              <div className="space-y-2 pt-2">
                ...
                <div className="flex items-center gap-2">
                  <a href="#" className="w-8 h-8 rounded-full bg-[#E1306C]/10 border border-[#E1306C]/40 text-[#E1306C] flex items-center justify-center hover:bg-[#E1306C] hover:text-white transition-all shadow-sm">
                  ...
                  <a href="#" className="w-8 h-8 rounded-full bg-[#1877F2]/10 border border-[#1877F2]/40 text-[#1877F2] flex items-center justify-center hover:bg-[#1877F2] hover:text-white transition-all shadow-sm">
                    <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24"><path d="M9 8H6v4h3v12h5V12h3.642L18 8h-4V6.333C14 5.374 14.5 5 15.5 5H18V0h-3.808C10.592 0 9 1.592 9 4.415V8z" /></svg>
                  </a>
                  <a href="#" className="w-8 h-8 rounded-full bg-[#E60023]/10 border border-[#E60023]/40 text-[#E60023] flex items-center justify-center hover:bg-[#E60023] hover:text-white transition-all shadow-sm">
                  ...
                  <a href="#" className="w-8 h-8 rounded-full bg-[#FF0000]/10 border border-[#FF0000]/40 text-[#FF0000] flex items-center justify-center hover:bg-[#FF0000] hover:text-white transition-all shadow-sm">
                    <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" /></svg>
                  </a>
                  <a href="#" className="w-8 h-8 rounded-full bg-[#25D366]/10 border border-[#25D366]/40 text-[#25D366] flex items-center justify-center hover:bg-[#25D366] hover:text-white transition-all shadow-sm">
            ...
            {/* ══════════════════════════════════════════
                2. COLUMNS 2-5: The 4 Navigation/Info Columns
            ══════════════════════════════════════════ */}
            <div className="lg:col-span-9 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              
              {/* Column 1: COLLECTIONS */}
              <div className="space-y-5 border-b lg:border-none border-[#221D22] pb-6 lg:pb-0">
                <h4 className="text-xs font-serif font-bold text-white tracking-widest uppercase flex items-center gap-2">
                  <Flower className="w-4 h-4 text-[#E4002B]" />
                  <span>COLLECTIONS</span>
                </h4>
                <ul className="space-y-3 text-[11px] lg:text-xs">
                  <li>
                    <Link href="/shop?category=flower-bouquets" className="hover:text-[#D4AF37] transition-colors flex items-center justify-between group">
                      ...
                      <ChevronRight className="w-3 h-3 text-[#555] group-hover:text-[#D4AF37] transition-all" />
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link href="/shop" className="hover:text-[#D4AF37] transition-colors flex items-center justify-between group text-white font-medium">
                      ...
                      <ChevronRight className="w-3 h-3 text-[#D4AF37] transition-all" />
                    </Link>
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-5 border-b lg:border-none border-[#221D22] pb-6 lg:pb-0">
                ...
                <ul className="space-y-3 text-[11px] lg:text-xs">
                  <li>
                    <Link href="/login" className="text-[#D4AF37] font-medium hover:underline flex items-center justify-between group">
              ...
              <div className="space-y-5 border-b lg:border-none border-[#221D22] pb-6 lg:pb-0">
                ...
                <ul className="space-y-3 text-[11px] lg:text-xs mb-4">
                  <li>
                ...
                <div className="p-3 rounded-xl bg-black border border-[#D4AF37]/30 shadow-inner mt-2">
                  <div className="flex items-center gap-1.5 text-[#D4AF37] text-[11px] font-bold mb-1">
                    <Lock className="w-3 h-3" />
                    <span>100% Secure Online Payment</span>
                  </div>
                  <p className="text-[9px] text-[#A39A90] leading-tight mb-2">
                    UPI, Credit/Debit Cards, Net Banking & Wallets powered by Razorpay.
                  </p>
                  
                  {/* Payment Logos Pill Badges */}
                  <div className="flex flex-wrap items-center gap-1.5 mb-2">
                    <span className="px-1.5 py-0.5 bg-white text-black text-[8px] font-black rounded">UPI</span>
                    <span className="px-1.5 py-0.5 bg-[#1A1F71] text-white text-[8px] font-bold rounded">VISA</span>
                    <div className="flex items-center relative w-5 h-3">
                      <div className="absolute left-0 w-3 h-3 bg-[#EB001B] rounded-full opacity-90 mix-blend-multiply"></div>
                      <div className="absolute right-0 w-3 h-3 bg-[#F79E1B] rounded-full opacity-90 mix-blend-multiply"></div>
                    </div>
                    <span className="px-1.5 py-0.5 bg-[#0066B3] text-white text-[8px] font-bold rounded">RuPay</span>
                  </div>

                  <div className="pt-1.5 border-t border-[#1C161C] flex items-center gap-1 text-[9px] text-[#E4002B]">
                    <span>❌</span>
              ...
              <div className="space-y-5">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="text-white text-xs font-medium">+91 98765 43210</div>
                      <div className="text-[10px] text-[#A39A90]">Mon - Sat: 9AM - 7PM</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="text-white text-xs font-medium">hello@happiwrapz.com</div>
                      <div className="text-[10px] text-[#A39A90]">We reply within 24 hrs</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="text-white text-xs font-medium">Happiwrapz Studio</div>
                      <div className="text-[10px] text-[#A39A90]">Coimbatore, Tamil Nadu<br/>India - 641001</div>
                    </div>
                  </div>
        ...
        ══════════════════════════════════════════ */}
        <div className="pt-2 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-[#A39A90] px-2">
          <p>© {new Date().getFullYear()} Happiwrapz. All rights reserved.</p>
          
          <div className="flex items-center gap-1 text-[#D4AF37] font-medium">
            <span>Crafted with</span>
            <Heart className="w-3 h-3 fill-[#E4002B] text-[#E4002B]" />
